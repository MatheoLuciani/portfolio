...
class ProjectController extends AbstractController
{
    ...
    public function index(): Response
    {
        $projects = [
            ...
            [
                'id' => 4,
                'title' => 'Infrastructure Virtualisée Vbox',
            ...
            [
                ...
                'description' => 'Création d\'un site web de gestion avec Symfony : authentification utilisateur, système CRUD complet, API REST, intégration de base de données MySQL, et interface responsive avec Bootstrap.',
